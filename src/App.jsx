...
import "./App.css";
import Navbar from "./components/navbar/Navbar.jsx"; //ricordarsi di importare il file seguendo il percorso giusto delle cartelle
...
function App() {
  ...
  return (
    //i componenti vanno sempre richiamati all'interno di un div che racchiude tutto
    <div className="App">
      <Navbar />
      {/* <button>Ciao</button> */}
      ...
      <Gallery GalleryObj={{ title: "Gallery", list: imagesList3 }} />
      <Footer />
    </div>
  );
}
...
/*GalleryObj è l'oggetto che troviamo nel componente Gallery, gli stiamo dicendo che il titolo sarà Gallery e l'array imagesList3*/
